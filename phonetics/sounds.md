...
7.  **H h**: **Hard** voiceless glottal fricative /h/ (`taht` [taht] 'throne') and *soft* voiceless uvular fricative /x/ (`heşt` [xeft] 'eight'). Occurs only in loanwords (academic); naturalized to `K` or skipped in authentic reading.
