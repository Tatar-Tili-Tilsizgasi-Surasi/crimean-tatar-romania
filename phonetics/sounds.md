...
7.  **H h**: **Hard** voiceless glottal fricative /x/ (`taht` [taxt] 'throne') and *soft* voiceless uvular fricative /h/ (`heşt` [heft] 'eight'). Occurs only in loanwords (academic); naturalized to `K` or skipped in authentic reading.
